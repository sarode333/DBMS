...
+-----+----------+----------+------------+--------+---------------+------------+-------------+----------------------+------------+--------+--------+------+---------------+
|   1 | Sanket   | Tambe    | 2003-02-19 | Male   | Gonde         | 9860200365 | A+          | High blood pressure  |          3 |   NULL |   NULL | NULL | NULL          |
|   2 | Swapnil  | Jadhav   | 2000-04-11 | Male   | SambhajiNagar | 9860200366 | O+          | None                 |          1 |   NULL |   NULL | NULL | NULL          |
|   3 | Prashant | Hinge    | 2004-08-18 | Male   | Kopargaon     | 9860200367 | B+          | Asthma               |          1 |   NULL |   NULL | NULL | NULL          |
|   4 | Adesh    | Jadhav   | 1993-08-18 | Male   | Yeola         | 9860200368 | O+          | Skin conditions:Acne |          1 |   NULL |   NULL | NULL | NULL          |
|   5 | Manoj    | Gambhire | 2007-03-29 | Male   | Pune          | 9860200369 | A+          | None                 |          1 |   NULL |   NULL | NULL | NULL          |
+-----+----------+----------+------------+--------+---------------+------------+-------------+----------------------+------------+--------+--------+------+---------------+
...
| pid | f_name   | l_name   | dob        | gender | address       | phone      | blood_group | medical_history      | test_count | height | weight | bmi   | health_status |
+-----+----------+----------+------------+--------+---------------+------------+-------------+----------------------+------------+--------+--------+-------+---------------+
|   1 | Sanket   | Tambe    | 2003-02-19 | Male   | Gonde         | 9860200365 | A+          | High blood pressure  |          3 |    160 |     50 | 19.53 | NULL          |
|   2 | Swapnil  | Jadhav   | 2000-04-11 | Male   | SambhajiNagar | 9860200366 | O+          | None                 |          1 |    175 |     70 | 22.86 | NULL          |
|   3 | Prashant | Hinge    | 2004-08-18 | Male   | Kopargaon     | 9860200367 | B+          | Asthma               |          1 |    180 |     90 | 27.78 | NULL          |
|   4 | Adesh    | Jadhav   | 1993-08-18 | Male   | Yeola         | 9860200368 | O+          | Skin conditions:Acne |          1 |    165 |    100 | 36.73 | NULL          |
|   5 | Manoj    | Gambhire | 2007-03-29 | Male   | Pune          | 9860200369 | A+          | None                 |          1 |    163 |     45 | 16.94 | NULL          |
+-----+----------+----------+------------+--------+---------------+------------+-------------+----------------------+------------+--------+--------+-------+---------------+
5 rows in set (0.0007 sec)
 MySQL  localhost:33060+ ssl  hms  SQL >
